        ...
        <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-5 shadow-xl">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <div className="bg-slate-950 p-3 rounded-xl border border-sky-500/30">
              <span className="text-xs text-sky-400 font-semibold block">1. New / Uncalled</span>
            ...
            <div className="bg-slate-950 p-3 rounded-xl border border-teal-500/30">
              <span className="text-xs text-teal-400 font-semibold block">2. Currently Baiting</span>
              <span className="text-2xl font-bold text-slate-100 font-mono">
            ...
            <div className="bg-slate-950 p-3 rounded-xl border border-amber-500/30">
              <span className="text-xs text-amber-400 font-semibold block">3. Top Scams</span>
              <span className="text-2xl font-bold text-slate-100 font-mono">
